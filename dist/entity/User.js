...
var User = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)({
  type: "text",
  unique: true
}), _dec4 = (0, _typeorm.Column)({
  type: "text",
  unique: true
}), _dec5 = (0, _typeorm.Column)("text"), _dec6 = (0, _typeorm.Column)("text"), _dec7 = (0, _typeorm.Column)("bool"), _dec(_class = (_class2 = (_temp = function User() {
  ...
  _initializerDefineProperty(this, "isConfirmed", _descriptor6, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "hash", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "isConfirmed", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
